...
function convertsButton(func, assetsImgInit, imgType, multi) {
  return React__default.createElement(DropButton, {
    imgMain: multi,
    jsx_Picture: [React__default.createElement("div", {
      onClick: function onClick() {
        func(INIT_VALUES_BY_TYPE["boolean"]);
      }
    }, React__default.createElement(BallButton, {
...
function toTypeByType(type, value, func, imgType) {
  return {
    Array: [React__default.createElement("div", {
      onClick: function onClick() {
        func(undefined);
      }
    }, React__default.createElement(BallButton, {
    ...
    Object: [React__default.createElement("div", {
      onClick: function onClick() {
        func(undefined);
      }
    }, React__default.createElement(BallButton, {
    ...
    Number: [React__default.createElement("div", {
      ...
      imgMain: returnImgByType(typeOfToJIType.word, imgType)
    })), value >= 0 ? React__default.createElement("div", {
      onClick: function onClick() {
    ...
    String: [regex_Boolean.test(value) ? React__default.createElement("div", {
      onClick: function onClick() {
        func("false" === value ? false : true);
      }
    }, React__default.createElement(BallButton, {
      imgMain: returnImgByType(typeOfToJIType["boolean"], imgType)
    })) : React__default.createElement(React__default.Fragment, null), regex_Number.test(value) ? React__default.createElement("div", {
      onClick: function onClick() {
        func(parseInt(value, 10));
      }
    }, " ", React__default.createElement(BallButton, {
      imgMain: returnImgByType(typeOfToJIType.number, imgType)
    })) : React__default.createElement(React__default.Fragment, null), regex_Img.test(value) ? React__default.createElement("div", {
      onClick: function onClick() {
        func(INIT_VALUES_BY_TYPE.img);
      }
    }, React__default.createElement(BallButton, {
      ...
      imgMain: returnImgByType(typeOfToJIType["null"], imgType)
    })), React__default.createElement(React__default.Fragment, null), React__default.createElement(React__default.Fragment, null), React__default.createElement(React__default.Fragment, null), React__default.createElement(React__default.Fragment, null), React__default.createElement(React__default.Fragment, null), React__default.createElement(React__default.Fragment, null), React__default.createElement(React__default.Fragment, null), React__default.createElement(React__default.Fragment, null), regex_Img_http.test(value) ? regex_https.test(value) ? React__default.createElement("div", {
      onClick: function onClick() {
        func(value);
      }
    }, React__default.createElement(BallButton, {
      ...
      imgMain: returnImgByType(typeOfToJIType.http, imgType)
    })) : extremTest_Assets(value) ? React__default.createElement("div", {
      onClick: function onClick() {
        func(value);
      }
    }, React__default.createElement(BallButton, {
    ...
    Boolean: [React__default.createElement("div", {
      onClick: function onClick() {
...
function allSquishChange(choiceSlc, el, i, isRandom) {
  ...
  var newSelec = lodash.cloneDeep(choiceSlc);
  ...
  if (isRandom === false) {
    ...
    if (i === 0) {
      ...
      return lodash.compact(_buildArr);
    }
  }
}
...
function allJipOperation(objUpdate, path, action, extra) {
  if (objUpdate !== null && typeof objUpdate === "object" && Array.isArray(objUpdate) === false && extra.onArrVal !== true) {
    return operationObj(lodash.cloneDeep(objUpdate), path, action, extra);
  }
...
function operationObj(objUpdate, path, action, extra) {
  ...
  if (action === "addValue") {
    ...
    if (extra.onArrVal === true) {
      ...
      var parentObj = parentPath === "" ? objUpdate : lodash.get(objUpdate, parentPath);
      parentObj.push(newValue);
      res = parentPath === "" ? parentObj : lodash.set(objUpdate, parentPath, parentObj);
    } else {
      var _parentPath = parentTo(path);

      var _parentObj = _parentPath === "" ? objUpdate : lodash.get(objUpdate, _parentPath);

      if (isObject && Object.keys(_parentObj).includes(newKey) === false) {
        _parentObj[newKey] = newValue;
        res = _parentPath === "" ? _parentObj : lodash.set(objUpdate, _parentPath, _parentObj);
      }
    }
  }
  ...
  if (action === "deleteValue") {
    ...
    var _parentObj2 = _parentPath2 === "" ? objUpdate : lodash.get(objUpdate, _parentPath2);

    var anotherObj = {};
    Object.keys(_parentObj2).forEach(function (key) {
      if (key === supprKey) ; else {
        anotherObj[key] = lodash.cloneDeep(_parentObj2[key]);
      }
    });
    res = _parentPath2 === "" ? anotherObj : lodash.set(objUpdate, _parentPath2, anotherObj);
  }
  ...
  if (action === "updateValue") {
    ...
    if (extra.onArrVal === true) {
      ...
      var _parentObj3 = _parentPath3 === "" ? objUpdate : lodash.get(objUpdate, _parentPath3);

      _parentObj3[iUpdate] = _newValue;
      res = _parentPath3 === "" ? _parentObj3 : lodash.set(objUpdate, _parentPath3, _parentObj3);
    } else {
      if (_isObject) {
        var _parentPath4 = parentTo(path);

        var _parentObj4 = _parentPath4 === "" ? objUpdate : lodash.get(objUpdate, _parentPath4);

        var ancientKey = lastKeyByType("Object", path);
        _parentObj4[_newKey] = _newValue === undefined ? lodash.get(objUpdate, path) : _newValue;
        var _anotherObj = {};
        Object.keys(_parentObj4).forEach(function (key) {
          _anotherObj[key === ancientKey ? _newKey : key] = lodash.cloneDeep(_parentObj4[key]);
        });
        res = _parentPath4 === "" ? _anotherObj : lodash.set(objUpdate, _parentPath4, _anotherObj);
      } else {
        res = lodash.has(objUpdate, path) ? lodash.set(objUpdate, path, _newValue) : "";
      }
    }
  }
...
function operationArr(objUpdate, path, action, extra) {
  var res = undefined;
  var objOfRes = path === "" ? objUpdate : lodash.get(objUpdate, path);
  ...
  if (action === "deleteValue") {
    ...
    var arrayObj = path === "" ? objUpdate : lodash.get(objUpdate, path);
    ...
    res = path === "" ? arrayObj : lodash.set(objUpdate, path, arrayObj);
    res = arrayObj;
  }
  ...
  return path === "" ? res : lodash.set(objUpdate, path, res);
}
...
function swap(input, index_A, index_B) {
  var cloneInput = lodash.cloneDeep(input);
...
var JsonFormInspect = /*#__PURE__*/function (_Component2) {
  ...
  _proto2.onAction = function onAction(path, action, extra) {
    ...
    var objUpdate = lodash.cloneDeep(this.state.objUpdate);
    ...
    if (action === "addValue" || action === "deleteValue" || action === "updateValue") {
      ...
      if (reObjOnDel === true) {
        ...
        setTimeout(function () {
          _this2.setState({
            objUpdate: allJipOperation(lodash.cloneDeep(objUpdate), path, action, extra)
          });
        }, 500);
      } else {
        this.setState({
    ...
    if (action === "getObjByPath") {
      return path === "" ? this.onAction("", "getStateObj") : lodash.get(objUpdate, path);
    }
  };
  ...
  _proto2.downloadTemplateSave = function downloadTemplateSave() {
    ...
    fileSaver.saveAs(jsonDownload.join(","), "JsonFormInspect_Template_.json");
  };
  ...
  _proto2.render = function render() {
    ...
    if (isLoad === false) {
      ...
      return React__default.createElement("div", null, this.props.isWithAccessory === true ? React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        style: {
          display: "flex"
        }
      }, React__default.createElement("p", null, "Configuration: "), React__default.createElement(Glass_, {
        text: "\u267B\uFE0F Reboot",
        onClick: function onClick() {
          _this3.reboot();
        }
      }), Object.keys(this.state.objSave) !== undefined && Object.keys(this.state.objSave).length !== 0 && lodash.isEqual(this.state.objUpdate, this.state.objSave) === false ? React__default.createElement(Glass_, {
        text: "\u23EA D\xE9faire",
        onClick: function onClick() {
          _this3.setState({
            objUpdate: null
      ...
      }) : React__default.createElement(React__default.Fragment, null), React__default.createElement(Glass_, {
        text: "\uD83D\uDCBE Save",
        onClick: function onClick() {
          _this3.setState({
            objSave: objUpdate
      ...
      }, React__default.createElement("p", null, "Stockage navigateur: "), React__default.createElement(DropDownSquish, {
        lght: 8,
      ...
      }), React__default.createElement(Glass_, {
        text: "\uD83D\uDCBE Save N+1",
        onClick: function onClick() {
      ...
      }), "Nouveaux Clefs : ", React__default.createElement("input", {
        style: {
          width: 200,
          height: 40,
      ...
      }, React__default.createElement(RenderInputByType_Jip, Object.assign({}, {
        extra: extra,
        setting: setting,
...
var Number_Jip = /*#__PURE__*/function (_Component3) {
  ...
  _proto3.render = function render() {
    ...
    return typeof isItemArray === "number" ? this.form() : React__default.createElement("div", {
      style: {
        marginRight: 10
      }
    }, React__default.createElement("div", {
    ...
    }), React__default.createElement("p", null, "Val")), permission.value === false ? React__default.createElement("div", {
      style: {
        display: "grid"
      }
    }, this.form(), React__default.createElement("p", null, this.state.value)) : React__default.createElement("p", null, this.state.value));
  };
...
var Array_Jip = /*#__PURE__*/function (_Component4) {
    ...
    if (this.state.arrNow !== null && this.state.arrNow.length !== 0 && this.state.arrNow.length === inherentValue.length) {
      this.setState({
        iUpdating: inherentValue.map(function (elA, iA) {
          return lodash.isEqual(elA, _this7.state.arrNow[iA]);
  ...
  _proto4.render = function render() {
    ...
    return React__default.createElement("div", {
    ...
    }, typeof swapItemArr.iBegin === "number" && typeof swapItemArr.iEnd === "number" && inherentValue !== undefined ? React__default.createElement("div", {
      style: {
        position: "fixed",
        top: 0,
        right: 0,
    ...
    })) : React__default.createElement(React__default.Fragment, null), inherentValue.map(function (itemValue, i) {
      ...
      }, swapItemArr.iBegin === i ? "🪂" : swapItemArr.iEnd === i ? "🎯" : "🖱️"), React__default.createElement("div", {
        style: {
          cursor: "pointer",
          position: "absolute",
          top: 0,
      ...
      }, React__default.createElement(RadientNum, {
        txt: i.toString()
      }))), React__default.createElement(JsonFormInspect, Object.assign({}, _extends({}, propsJip, {
      ...
      }))), React__default.createElement(DropButton, {
...
var Obj_Jip = /*#__PURE__*/function (_Component5) {
  ...
  _proto5.render = function render() {
    ...
    return React__default.createElement("div", {
      ...
      return React__default.createElement(PairKeyValue_Jip, Object.assign({}, {
        path: newPath,
        deep: deep + 1,
        initKey: keysObj,
    ...
    }), React__default.createElement(AddButtons_Jip, Object.assign({}, {
      onAction: onAction,
      extra: extra,
      isItemArray: isItemArray,
...
var Color_Jip = /*#__PURE__*/function (_Component8) {
  ...
  _proto8.render = function render() {
    ...
    return React__default.createElement("div", null, React__default.createElement(reactColor.SketchPicker, {
    ...
    }), React__default.createElement(DropDownSquish, {
      lght: 10,
      choices: ["Rgb", "Hsl", "Hex"],
...
var AssetImg_Jip = /*#__PURE__*/function (_Component9) {
  ...
  _proto9.render = function render() {
    ...
    }, typeof this.state.value === "string" ? React__default.createElement("img", {
...
var ImgHttpOrS = /*#__PURE__*/function (_Component10) {
  ...
  _proto10.render = function render() {
    ...
    }, React__default.createElement(InputHttp, Object.assign({}, {
      color: "",
      img: {
...
var InputHttp = /*#__PURE__*/function (_Component11) {
  ...
  _proto11.render = function render() {
    ...
    return React__default.createElement("div", {
      ...
      className: "title"
    }, words.title), React__default.createElement("p", {
      className: "desc"
    }, words.desc), React__default.createElement("div", {
...
var Word_Jip = /*#__PURE__*/function (_Component12) {
  ...
  _proto12.form = function form() {
    ...
    return isKeys && permission.key || permission.value && isKeys === false ? React__default.createElement("p", null, this.state.value) : React__default.createElement("div", {
      style: {
        display: "flex"
      },
      className: "minus"
      ...
      value: this.state.value
    }), this.state.value !== inherentValue ? React__default.createElement(Glass_, {
      text: "\u2714\uFE0F",
      onClick: function onClick() {
  ...
  _proto12.render = function render() {
    ...
    return typeof isItemArray === "number" ? this.form() : React__default.createElement("div", {
    ...
    }, isKeys ? React__default.createElement("div", {
      style: {
        display: "flex"
      }
    }, React__default.createElement("img", {
      ...
      src: extra.IMG_INTERN.JsonForm.key
    }), React__default.createElement("p", null, "Clef")) : React__default.createElement("div", {
      style: {
        display: "flex"
      }
    }, React__default.createElement("img", {
    ...
    }), React__default.createElement("p", null, "Val")), this.form());
  };
...
var RenderInputByType_Jip = /*#__PURE__*/function (_Component14) {
  ...
  _proto14.render = function render() {
    ...
    var KeyManip = type === typeOfToJIType.word && isKeys === true ? React__default.createElement(BasicModal, Object.assign({}, {
      onAction: onAction,
      path: path,
      type: "key",
      onArrVal: false,
    ...
    return React__default.createElement("div", {
    ...
    }, KeyManip, type === typeOfToJIType.word ? React__default.createElement(Word_Jip, Object.assign({}, genData)) : typeOfToJIType.assetImg === type ? React__default.createElement(AssetImg_Jip, Object.assign({}, genData)) : typeOfToJIType.http === type || typeOfToJIType.https === type ? React__default.createElement(ImgHttpOrS, Object.assign({}, genData)) : typeOfToJIType.color === type ? React__default.createElement(Color_Jip, Object.assign({}, genData)) : typeOfToJIType.number === type ? React__default.createElement(Number_Jip, Object.assign({}, genData)) : typeOfToJIType["boolean"] === type ? React__default.createElement(Boolean_Jip, Object.assign({}, genData)) : typeOfToJIType.array === type ? React__default.createElement(Array_Jip, Object.assign({}, {
      deep: deep,
      extra: extra,
      isItemArray: isItemArray,
      onAction: onAction,
      ...
      inherentValue: inherentValue,
      path: path
    })) : typeOfToJIType.object === type ? React__default.createElement(Obj_Jip, Object.assign({}, {
      path: path,
      sub: genData,
      isItemArray: isItemArray,
      deep: deep,
      ...
      onAction: onAction,
      inherentValue: inherentValue
    })) : typeOfToJIType["null"] === type ? React__default.createElement("img", {
    ...
    }) : typeOfToJIType.undefined === type ? React__default.createElement("img", {
      style: _extends({}, cssImgOnlyRender, {
        width: 55,
        height: 55,
        marginRight: 5
    ...
    }) : React__default.createElement(React__default.Fragment, null), isKeys === false ? React__default.createElement("div", {
      style: {
        display: "flex",
        marginLeft: -8
      },
      className: "minus"
    }, typeOfToJIType.word === type ? React__default.createElement(BasicModal, Object.assign({}, {
      ...
      custom: extra.IMG_ASST,
      textIndu: extra.TextTemplate
    })) : React__default.createElement(React__default.Fragment, null), typeOfToJIType.assetImg === type ? React__default.createElement(BasicModal, Object.assign({}, {
      data: extra.IMG_ASST,
      custom: extra.IMG_ASST,
      onAction: onAction,
      path: path,
      ...
      onArrVal: isItemArray !== false,
      textIndu: extra.TextTemplate
    })) : React__default.createElement(React__default.Fragment, null), isItemArray === false ? React__default.createElement("div", {
      style: {
        display: "flex"
      }
    }, React__default.createElement(DropButton, {
      ...
      upFormVal(onAction, path, value, isItemArray);
    }, extra.IMG_ASST.Jpg.Bac[0], extra.IMG_INTERN.Type, extra.IMG_INTERN.Extra.multi)) : React__default.createElement(React__default.Fragment, null)) : React__default.createElement(React__default.Fragment, null));
  };
...
var Glass_ = /*#__PURE__*/function (_Component16) {
  ...
  _proto16.render = function render() {
    ...
    return React__default.createElement("div", {
      ...
      className: "container"
    }, link !== undefined ? React__default.createElement(reactRouterDom.Link, {
      to: link,
      href: href
    }, React__default.createElement("div", {
      className: "btn effect01"
    }, React__default.createElement("span", null, text))) : React__default.createElement("a", {
      href: href,
      className: "btn effect01"
...
var PanelViewTsx = /*#__PURE__*/function (_Component19) {
  ...
  _proto19.getCustom = function getCustom() {
    ...
    var objEl = lodash.cloneDeep(arrVal);
  ...
  _proto19.render = function render() {
    ...
    return React__default.createElement("div", null, React__default.createElement("div", {
      ...
      return React__default.createElement("div", null, React__default.createElement(DropDownSquish, {
        lght: 7,
    ...
    }, CUSTOM === null ? React__default.createElement(React__default.Fragment, null) : this.props.isKey ? React__default.createElement("p", {
      className: "pRes",
      style: {
        fontSize: 50
      }
    }, CUSTOM) : /\/static*/gm.test(CUSTOM) ? React__default.createElement("img", {
      src: CUSTOM,
      style: {
        width: 500,
        height: 500
      ...
      className: "pRes"
    }, CUSTOM), CUSTOM === null ? React__default.createElement(React__default.Fragment, null) : React__default.createElement("div", {
      style: {
        position: "absolute",
        top: 75,
        left: "-15vw"
...
var BasicModal = /*#__PURE__*/function (_Component20) {
  ...
  _proto20.render = function render() {
    ...
    return React__default.createElement("div", {
      ...
      text: "Fermer"
    }), React__default.createElement(PanelViewTsx, Object.assign({}, {
      isKey: type === "key",
      initAsstImg: {
        isRandom: true
      },
...
exports.JsonFormInspect = JsonFormInspect;
//# sourceMappingURL=jsoninspectorhelper.cjs.development.js.map
