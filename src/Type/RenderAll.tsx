...
import { FormGetRenderInputByType, FormGetJip, typeOfToJIType, FormPushJip } from "../Util/Model";
...
export class RenderInputByType_Jip extends Component<FormGetRenderInputByType, any>{
    render() {
        const { isKeys, type, setting, extra, handleValue, id, isItemArray, onAction, deep, inherentValue } = this.props;
                    ...
                    : typeOfToJIType.color === type ? <Color_Jip {...genData} />
                        : typeOfToJIType.number === type ? <Number_Jip {...genData} />
                            : typeOfToJIType.boolean === type ? <Boolean_Jip {...genData} />
                                ...
                                // }} />
                                : typeOfToJIType.object === type ? <Obj_Jip {...{ id, path: (onAction(id!, "getObj") as FormPushJip)!.path, sub: genData, isItemArray, deep, setting, extra, onAction, handleValue }} />
